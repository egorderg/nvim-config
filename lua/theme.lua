...
-- CMP
CmpItemAbbrDeprecated { fg = '#808080', bg = 'NONE', gui = 'strikethrough' };
CmpItemAbbrMatch { fg =  '#18A3FF', bg = 'NONE' };
CmpItemAbbrMatchFuzzy { CmpItemAbbrMatch };

SuggestWidgetBorder { fg = '#454545' };
SuggestWidgetSelect { bg = '#094771' };
